...
I18n.translations.pt_PT['lssm']['dashboard'] = {
    ...
    station_plan: "Planeamento de Estação",
    loading: "Dashboard está a carregar",
    ge: 'Edifícios',
    school: 'Escolas',
    wachen: 'Estações',
    other: 'Outros',
    ...
    patiwp: 'PACIENTES',
    levwp: 'NÍVEL',
    categories: ['Quartel dos Bombeiros', 'Estação de Salvamento', 'Esquadra da Polícia', 'Hospital'],
    categories_data: ['qb', 'es', 'esq', 'hp'],
    categories_data_school: ['escola_qb', 'escola_es', 'esq_escola', 'hp_clinica'],
    nofz: "Nenhum veículo encontrado",
}
